      ...
      <div className="col-md-5 mx-auto">
        ...
        <div className="bg-white shadow rounded overflow-hidden">
            ...
            <div className="media align-items-end profile-head">
              ...
              <div className="media-body mb-5 text-white">
                ...
                <p className="small mb-4">
                  <i className="fas fa-map-marker-alt mr-2"></i>New York</p>
              </div>
            </div>
          </div>
          ...
          <div className="py-4 px-4">
            <div className="d-flex align-items-center justify-content-between mb-3"> <h5 className="mb-0">Recent photos</h5><a href="#" className="btn btn-link text-muted">Show all</a> </div>
            <div className="row">
